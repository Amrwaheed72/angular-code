...
export class HomeComponent {
  healthTips: HealthTip[] = [
    {
      title: 'Stay Hydrated!',
      text: 'Drinking 8 glasses of water daily helps regulate blood pressure.',
    },
    {
      title: 'Check Your Sugar',
      text: 'Regular monitoring helps you understand your body better.',
    },
    {
      title: 'Walk Regularly',
      text: 'A 15-minute walk after meals improves digestion significantly.',
    },
